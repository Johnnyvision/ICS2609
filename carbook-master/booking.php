...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Drive<span>N</span>Jive</a>
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="connect.php" method="post" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input type="text" class="form-control" id="messageA" name="messageA" placeholder="Message"></textarea>
              </div>
              <div class="form-group">
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2"><a href="#" class="logo">Drive<span>N</span>Jive</a></h2>
        ...
        <div class="row">
          ...
          <p>
				 All rights reserved | This website is created by Group 2
				</p>
          </div>
        </div>
      </div>
